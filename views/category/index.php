							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<?php //Html::img("@web/images/products/{$hit->img}", ['alt' => $hit->name]) ?>
											<?= Html::img($mainImg->getUrl('268x249'), ['alt' => $hit->name]) ?>
											<h2>$<?= $hit->price ?></h2>
											<p style="height: 30px"><a href="<?=yii\helpers\Url::to(['product/view', 'id' => $hit->id]);?>"><?= $hit->name ?></a></p>
                                        ...
                                        <?php endif; ?>
										<!-- <img class="new" alt="" src="images/home/new.png"> -->
								</div>
								<div class="choose">
