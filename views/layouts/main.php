					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +77777777</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> vitalsh189@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?= yii\helpers\Url::home(); ?>">
								<?= Html::img('@web/images/home/logo.png', ['alt' => 'My-shop']); ?></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a class="showcart" href="#"><i class="fa fa-shopping-cart"></i> Cart</a></li>
